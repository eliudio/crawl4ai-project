...
registered here - see feed_importers.py's own registry instead, a separate
...
# through afterwards (local_event_scraper.py's own per-event loop, sliced there for
